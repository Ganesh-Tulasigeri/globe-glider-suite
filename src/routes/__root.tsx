    ...
    scripts: [
      {
        ...
        // Defaults to light mode when no preference is stored.
        children:
          "try{var t=localStorage.getItem('lt-theme');if(t!=='light'&&t!=='dark'){t='light'}if(t==='dark')document.documentElement.classList.add('dark')}catch(e){}",
      },
      {
